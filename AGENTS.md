...
When the user asks for a pull request title/body or PR description, follow `docs/PR_Template.md` by default unless the user explicitly requests a different format.
Unless the user explicitly requests another language, write PR content primarily in Korean.
